<template>
  <div id="MainLayout" class="w-full fixed z-50">
    <div id="TopMenu" class="w-full bg-[#fafafa] border-b md:block hidden">
      <ul
        class="flex justify-end items-center text-xs text-[#333333] font-light px-2 h-10 bg-[#fafafa] max-w-[1200px]"
      >
        <li
          ...
          >
            <div v-if="!user">
              ...
              <div class="flex items-center gap-1 px-3 mb-3">
                <NuxtLink
                  to="/auth"
                  class="bg-[#ff4646] text-center w-full text-[16px] rounded-sm text-white p-2 font-semibold"
                >
                  Login / Register
                </NuxtLink>
              </div>
              ...
              >
                ...
                >
                  <div class="flex items-center">
                    <img width="40" :src="item.url" class="rounded-md" />
